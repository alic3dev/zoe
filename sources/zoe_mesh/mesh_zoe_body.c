...
void mesh_zoe_body_initialize(
  ...
  for (
    unsigned int index_vertex_hips = (
      0x00
    );
    (
      index_vertex_hips <
  ...
  for (
    unsigned int index_vertex_torso = (
      0x00
    );
    (
      index_vertex_torso <
  ...
  for (
    ...
    for (
      unsigned int index_vertex_shoulder = (
        0x00
      );
      (
    ...
    for (
      unsigned int index_vertex_upper_arm = (
        0x00
      );
      (
    ...
    for (
      unsigned int index_vertex_forearm = (
        0x00
      );
      (
